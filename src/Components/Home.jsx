...
import me from './images/AppImages/goat.png'
...
<div className="divsvgpr" >
    ...
    <div className="imgcontainer">
     <img src={me} className="me" width="150px" alt=""/>
     </div>
</div>
    /*
        ...
        <div className="stcontainer">
         {
            skills?.map((skill)=>(
                <div key={skill._id}>
                    <img  src ="https://mernbackend-vhvd.onrender.com/public/1709400398512_goat0000.jpg" width="50px" alt="" />
